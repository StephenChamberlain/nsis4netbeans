...
public final class NsiVisualElement extends JPanel implements MultiViewElement {
    ...
    private final NsiDataObject nsisDataObject;
    private final JToolBar toolbar = new JToolBar();

    public NsiVisualElement(final Lookup lookup) {
        nsisDataObject = lookup.lookup(NsiDataObject.class);
        assert nsisDataObject != null;
        initComponents();
    }
    ...
    public Lookup getLookup() {
        return nsisDataObject.getLookup();
    }
